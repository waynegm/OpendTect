...
static const char* rcsID mUsedVar = "$Id: vishorizontexturehandler.cc 28563 2013-04-16 18:05:13Z ding.zheng@dgbes.com $";
...
void HorizonTextureHandler::setColTabSequence(int channel, const ColTab::Sequence& se)
{
    if ( channel>=0 ) channel2rgba_->setSequence( channel, se );
}


const ColTab::Sequence* HorizonTextureHandler::getColTabSequence( int channel ) const
{
...
const ColTab::MapperSetup* HorizonTextureHandler::getColTabMapperSetup( int ch ) const
{
